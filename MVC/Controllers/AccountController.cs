...
namespace Restaurant.Controllers
{
    public class AccountController : Controller
    {
        ...
        //    {
        //        IList<string> roleNames = await _userManager.GetRolesAsync(account);
        //        IdentityRole role = (roleNames != null && roleNames.Count > 0) ? await _roleManager.FindByNameAsync(roleNames[0]) : null;
        //        if (role != null && role.Name == "Eigenaar")
        //        {
        //            int eigenaarCount = (await _userManager.GetUsersInRoleAsync("Eigenaar")).Count;
        //            if (eigenaarCount <= 1)
        //            {
        //                ModelState.AddModelError("", "Cannot delete the last 'Eigenaar' account.");
        //                return RedirectToAction("Index");
        //            }
        //        }
        ...
        //        //account.Gemeente = "<>";
        //        account.Actief = false;
        //        account.Voornaam = "<<Verwijderd>>";
        //        account.Achternaam = "<<Verwijderd>>";
        //        account.Adres = "<<Verwijderd>>";
        //        account.Huisnummer = "<<Verwijderd>>";
        //        account.Postcode = "<<Verwijderd>>";
        //        account.Gemeente = "<<Verwijderd>>";
