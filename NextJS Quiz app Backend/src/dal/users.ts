...
export async function getUsers(userNameParam: string = ''): Promise<User[]> {
  return prismaClient.user.findMany({
    where: {
      OR: [
        {username: {contains: userNameParam, mode: 'insensitive'}},
        {email: {contains: userNameParam, mode: 'insensitive'}}
      ]
